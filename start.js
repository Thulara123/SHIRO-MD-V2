...
async function downloadAndExtractZip() {
  try {
    ...
    console.log('SHIRO-MD ZIP file downloaded successfully ✅');
...
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://github.com/Thulara123/SHIRO-MD/blob/main/asset/SHIRO-MD.jpg` }, caption: up })
        ...
        try {
            ...
            if (action === 'add') {
                try {
                    ...
                    profilePicUrl = 'https://github.com/Thulara123/SHIRO-MD/blob/main/asset/SHIRO-MD.jpg'; // Default image URL
                }
                ...
                if (welcome === true) {
                    ...
                    *Hey @${participant.split('@')[0]}!* 👋
                    ...
                    > 🟢 *SHIRO MD WhatsApp Bot* is up and running!
                    Runtime: ${runtime(process.uptime())}\n
                    > 🛠️ *Created by:* {C0De_Zero}; \n
                    ...
                    *POWERED by SHIRO-MD*\n
                    *💻 GitHub:* https://github.com/Thulara123/SHIRO-MD-V2\n`;
                }
                ...
                try {
                    ...
                    profilePicUrl = 'https://github.com/Thulara123/SHIRO-MD/blob/main/asset/SHIRO-MD.jpg'; // Default image if failed
                }
                const welcome = getWelcome();  // Ensure this function returns true
                if (welcome === true) {
                    message = `⫷⦁[ * '-'_꩜ 𝙰 𝚂 𝙸 𝚃 𝙷 𝙰 𝙼 𝙳 ꩜_'-' * ]⦁⫸
                    ...
                    *💻 GitHub:* github.com/Thulara123/SHIRO-MD-V2\n`;
                }
            }
                ...
                await conn.sendMessage(id, {
                    ...
                    contextInfo: {
                        ...
                        externalAdReply: {
                            ...
                            body: 'ASHIRO MD',
                            mediaType: 1,
                            sourceUrl: "https://github.com/Thulara123",
                            thumbnailUrl: 'https://github.com/Thulara123/SHIRO-MD/blob/main/asset/SHIRO-MD.jpg'
                        }
                    }
                });
            }
...
console.log("SHIRO MD CHANNEL FOLLOW ✅")
}	 
...
q = args.join(' ')		
  ...
  return await conn.sendMessage(from, { text: teks }, { quoted: mek })
    ...
    //await conn.sendMessage(from, { audio: fs.readFileSync("./" + type.ext), mimetype:  originalMessage.message.audioMessage.mimetype, fileName:  `${m.id}.mp3` })	
     const sdata = await conn.sendMessage(delfrom,{sticker: fs.readFileSync("./" + type.ext) ,package: 'SHIRO 🌟'})
    return await conn.sendMessage(delfrom, { text: `🚫 *This message was deleted !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n` },{quoted: sdata});
    
    }else{
    
    const stdata = await conn.sendMessage(delfrom,{sticker: fs.readFileSync("./" + type.ext) ,package: 'SHIRO 🌟'})
    return await conn.sendMessage(delfrom, { text: `🚫 *This message was deleted !!*\n\n  🚮 *Deleted by:* _${deletedBy}_\n  📩 *Sent by:* _${sentBy}_\n` },{quoted: stdata});
...
if(senderNumber.includes("94772884694")){
if(isReact) return
m.react("👾")
}
//read commands
...
await conn.sendMessage(from, { text: "❌ ```Another Bot's message Detected :``` 📚 *Removed By SHIRO-MD* ❗\nAnti Bot System on..." })
if ( config.ANTI_BOT == "true" && isBotAdmins ) {
await conn.sendMessage(from, { delete: mek.key })
await conn.groupParticipantsUpdate(from,[sender], 'remove')
  }}
    if ( mek.id.startsWith("QUEENAMDI") ) {
await conn.sendMessage(from, { text: "❌ ```Another Bot's message Detected :``` *💃 SHIRO-MD* ❗\n*Removed By SHIRO-MD* ❗\nAnti Bot System on..." })
if ( config.ANTI_BOT == "true" && isBotAdmins ) {
await conn.sendMessage(from, { delete: mek.key })
await conn.groupParticipantsUpdate(from,[sender], 'remove')
  }}
