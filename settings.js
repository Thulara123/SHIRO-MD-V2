...
SESSION_ID: process.env.SESSION_ID === undefined ? 'nA5UzBoY#a8WcRZIE40w_KQ-HwADg0XP0826Y_GPkZd3Nq-F0Z5Q' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94772884694' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "shiro" : process.env.SESSION_NAME,
